...
final class Version20191217123657 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE repas_favoris (id INT AUTO_INCREMENT NOT NULL, posted_by_id INT NOT NULL, repas_id INT NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_F45DACDE5A6D2235 (posted_by_id), INDEX IDX_F45DACDE1D236AAA (repas_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE repas_favoris ADD CONSTRAINT FK_F45DACDE5A6D2235 FOREIGN KEY (posted_by_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE repas_favoris ADD CONSTRAINT FK_F45DACDE1D236AAA FOREIGN KEY (repas_id) REFERENCES repas (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE repas_favoris');
