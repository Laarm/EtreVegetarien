...
final class Version20191217123657 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE meal_favoris (id INT AUTO_INCREMENT NOT NULL, posted_by_id INT NOT NULL, meal_id INT NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_F45DACDE5A6D2235 (posted_by_id), INDEX IDX_F45DACDE1D236AAA (meal_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE meal_favoris ADD CONSTRAINT FK_F45DACDE5A6D2235 FOREIGN KEY (posted_by_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE meal_favoris ADD CONSTRAINT FK_F45DACDE1D236AAA FOREIGN KEY (meal_id) REFERENCES meal (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE meal_favoris');
