...
final class Version20191119162735 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article_comment (id INT AUTO_INCREMENT NOT NULL, article_id INT DEFAULT NULL, posted_by VARCHAR(255) NOT NULL, contenu VARCHAR(255) NOT NULL, for_article VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_FD7302DB7294869C (article_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
