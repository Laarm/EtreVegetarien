...
final class Version20191217103256 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product_favoris (id INT AUTO_INCREMENT NOT NULL, posted_by_id_id INT NOT NULL, product_id_id INT NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_4FC84F4BD050B9D4 (posted_by_id_id), INDEX IDX_4FC84F4B4FD8F9C3 (product_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE product_favoris ADD CONSTRAINT FK_4FC84F4BD050B9D4 FOREIGN KEY (posted_by_id_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE product_favoris ADD CONSTRAINT FK_4FC84F4B4FD8F9C3 FOREIGN KEY (product_id_id) REFERENCES product (id)');
