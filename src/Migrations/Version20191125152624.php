...
final class Version20191125152624 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE meal ADD posted_by_id INT NOT NULL');
        $this->addSql('ALTER TABLE meal ADD CONSTRAINT FK_A8D351B35A6D2235 FOREIGN KEY (posted_by_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_A8D351B35A6D2235 ON meal (posted_by_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_A8D351B35A6D2235 ON meal');
        $this->addSql('ALTER TABLE meal DROP posted_by_id');
